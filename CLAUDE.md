...
doraemon-skills 是从 doraemon-skills 生成的品牌仓库。其他品牌仓库（paoding/davinci/doraemon）
通过独立的 brand-sync-tool 从 doraemon-skills 生成，各自拥有独立的 git 历史。
...
| Remote | GitHub 仓库 | 用途 |
|--------|-----------|------|
| origin | zwyin/doraemon-skills | 推送 |
