...
- `skills/doraemon-project-walkthrough/SKILL.md` — Canonical skill definition (single source of truth)
...
- `skills/doraemon-project-walkthrough/SKILL.md` — Skill logic, parameters, process
