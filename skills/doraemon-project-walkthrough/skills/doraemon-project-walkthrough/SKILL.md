...
- `<prefix>` — the brand prefix, first segment of the `name` field in frontmatter (e.g., derived from `doraemon-project-walkthrough`)
...
3. Run the converter tool as the primary HTML generation method:
   ...
   - `--tool-name <name>`: tool name shown in the promo page (default: `doraemon-project-walkthrough`)
