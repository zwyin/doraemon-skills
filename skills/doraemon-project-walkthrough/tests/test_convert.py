...
SKILL_MD = ROOT / "skills" / "doraemon-project-walkthrough/SKILL.md"
CURSOR_FILE = ROOT / "cursor" / "doraemon-project-walkthrough.mdc"
WINDSURF_FILE = ROOT / ".windsurf" / "rules" / "doraemon-project-walkthrough.md"
OPENCODE_FILE = ROOT / ".opencode" / "skills" / "doraemon-project-walkthrough" / "SKILL.md"
...
class TestOpenCodeFile:
    ...
    def test_frontmatter_has_name(self):
        ...
        assert fm.get("name") == "doraemon-project-walkthrough"
