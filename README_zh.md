...
Claude Code skill 合集——一只装满生产力工具的四维口袋。

[English](README.md) | 中文

> 哆啦A梦（Doraemon）：如同那只四维口袋里装满神奇道具的机器猫。每个 skill 都是一件能即刻解决你问题的好用具。
...
```bash
clawhub install doraemon-github-safe-publish
clawhub install doraemon-project-walkthrough
```
...
[→ 查看完整文档](skills/doraemon-github-safe-publish/docs/README_zh.md)
...
[![version](https://img.shields.io/badge/version-1.6.5-blue)](skills/doraemon-project-walkthrough/skills/doraemon-project-walkthrough/SKILL.md)
...
[→ 查看完整文档](skills/doraemon-project-walkthrough/README.md)
...
```bash
# macOS / Linux
cat ~/.claude/plugins/cache/doraemon-skills/*/skills/*/skills/*/SKILL.md | grep version
```

Or ask Claude directly:

```
我安装的 doraemon-skills 是什么版本？
```
